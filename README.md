...
在参考了人类自然语言和现有计算机语言的特点之后, 这里决定采用 `谓主宾结构`(如圣经希伯来语, 古典阿拉伯语和许多马雅语族语言).
另有`状语`基本语法结构放在`谓主`之间.
各语法元素中, `谓语`和`宾语`必须存在, `主语`则可省略, 而`修饰词`只有存在主语时才可以加. 即, 合法句式只有如下三种:
- `verb(o1 o2 ...)`
- `verb@sub(o1 o2 ...)`
- `verb(modifier)@sub(o1 o2 ...)`
